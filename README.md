...
My name is Cameron Peterson, I grew up in Alaska, and have lived there for over 20 years. My hobbies include software development(coding), video games, fishing, and woodworking.

I have worked on multiple self-guided projects. Two of them were requested by Ptarmigan Pediatrics, the first being [Camvax](https://github.com/IDzyre/camvax), a self-hosted vaccine inventory and tracking web-app, built to try to reduce wasted vaccines, and keep track of inventory. This reduced undue waste from an average of 10 vaccines per month, to less than 1  per month.

The second is [Ptimecard](https://github.com/IDzyre/Ptimecard), a timecard system that allows for requesting time off, and tracking it VIA a calendar. 
